...
cl.exe %CFLAGS% %INCLUDES% /Fedede src\main.c src\app.c src\la.c src\editor.c src\file_browser.c src\free_glyph.c src\simple_renderer.c src\common.c src\lexer.c src\vim.c src\command.c src\config.c /link %LIBS% -SUBSYSTEM:windows
